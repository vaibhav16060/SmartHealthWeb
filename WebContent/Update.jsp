...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-md-9">
      ...
      <h2><font color="Blue">Update Your Detail. Leave the fields you don't want to update blank</font></h2>
      <hr>
      <br><br>
      <form class="form-horizontal" action="updateForWeb" method="post">
	        <div class="form-group">
	          <label class="col-md-2 control-label">First Name</label>
	          <div class="col-md-6">
	            <input class="form-control" name="tb_first_name" type="text" placeholder="First Name...">
	          </div>
	        ...
	        <div class="form-group">
	          ...
	          <div class="col-md-6">
	            <input class="form-control" name="tb_last_name" type="text" placeholder="Last Name...">
	          </div>
	          <div class="col-md-4"></div>
	        </div>
	        <div class="form-group">
	        ...
	        <div class="form-group">
	          ...
	          <div class="col-md-6">
	            <input class="form-control" name="tb_address" type="text" placeholder="Address...">
	          </div>
	          <div class="col-md-4"></div>
	        </div>
	        <div class="form-group">
	          <label class="col-md-2 control-label">Information about You</label>
	          <div class="col-md-6">
	            <input class="form-control" name="tb_about" type="text" placeholder="About...">
	          </div>
	          <div class="col-md-4"></div>
	        </div>
	      	<%if(cont.get_user_type().equals("Moderator")){ %>
	      		<div class="form-group">
	          		<label class="col-md-2 control-label">Qualifications</label>
	          		<div class="col-md-6">
	           			 <input class="form-control" name="tb_edu_details" type="text" placeholder="Qualifications...">
	          		</div>
	          		<div class="col-md-4"></div>
	       		 </div>
	      	<%} %>
