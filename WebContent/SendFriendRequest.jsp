	...
	<div class="container-fluid">
	  <div class="row content">
	    <div class="col-md-3 sidenav">
	      ...
	      <ul class="nav nav-pills nav-stacked">
        	...
        	if(cont.get_user_type().equals("EndUser")){%>
		        <li class="active"><a href="SendFriendRequest.jsp">Send Request</a></li>
	    ...
	    <div class="col-md-9">
	      ...
	      <h2><font color="Blue">Send a Request !</font></h2>
	      <hr>
	      <br>
	      <form id="friend_req_form" action="sendRequestWeb" method="post" class="jumbotron">
	      	<div class="row">
	      	...
	      	<%
	      		if(!cont.get_user_type().equals("EndUser")){}
	      			...
	      			for(int j = 0 ; all_people != null && j < all_people.length ; j++){
	      			%>
	      				<div class="row">
		      				<div class="col-md-4">
		      					<p><%=all_people[j][0]%></p>
		      				...
		      				<div class="col-md-4">
		      					<button type="submit" name="<%=j%>"  class="btn btn-success">Send Request</button>
		      				</div>
	      				</div>
	      		<%
	      			}
