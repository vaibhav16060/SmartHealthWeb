	...
	<div class="container-fluid">
	  <div class="row content">
	    <div class="col-md-3 sidenav">
	      ...
	      <ul class="nav nav-pills nav-stacked">
        	...
        	if(cont.get_user_type().equals("EndUser")){%>
		        ...
		        <li class="active"><a href="SeeFriendRequest.jsp">See Request</a></li>
	    ...
	    <div class="col-md-9">
	      ...
	      <h2><font color="Blue">Accept / Reject Friend Request</font></h2>
	      <hr>
	      <br>
	      <form id="friend_req_form" action="seeRequestWeb" method="post" class="jumbotron">
	      	<div class="row">
	      		<div class="col-md-4"><p><u>Username</u></p></div>
	      		<div class="col-md-4"><p><u>Name</u></p></div>
	      	...
	      	<%
	      		if(!cont.get_user_type().equals("EndUser")){}
	      			...
	      			for(int j = 0 ; recv != null && j < recv.length ; j++){
	      			%>
	      				<div class="row">
		      				<div class="col-md-4">
		      					<p><%=recv[j][0]%></p>
		      				...
		      				<div class="col-md-2">
		      					<button type="submit" name="A<%=j%>"  class="btn btn-success">Accept</button>
		      				</div>
		      				<div class="col-md-2">
		      					<button type="submit" name="R<%=j%>"  class="btn btn-danger">Reject</button>
		      				</div>
	      				</div>
	      		<%
	      			}
