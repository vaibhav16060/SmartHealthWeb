...
/**
 * Servlet implementation class imageUploadForWeb3
 */
@WebServlet("/imageUploadForWeb3")
public class imageUploadForWeb3 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public imageUploadForWeb3() {
        super();
					...
					while (iterator.hasNext()) {
	                     ...
	                     if (!item.isFormField()) {
	                         ...
	                         forward[0] = false; name[0] = "";
	             			 ...
	             			 forward[2] = true; name[2] = fileName;
